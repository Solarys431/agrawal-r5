...
\(p\mid H_n\).  The converse construction of a labelled transport from
\(p\mid H_n\), including the common-sign repair, is not asserted by the
Lean theorem and remains outside the release kernel.
...
At the release state audited for this version there are twenty-seven modules
and \(3520\) source lines; no \lean{sorry}, no \lean{admit}, and no axioms
