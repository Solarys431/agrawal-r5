...
while \lean{IsCarmichael.fermatPsp} — Korselt's criterion proper, that a
Carmichael number is a Fermat pseudoprime to every coprime base — is proved
for completeness and is \emph{not} used in the proof of
Theorem~\ref{thm:lenstra}, which needs only the divisibility conditions
themselves.
...
Twenty-two modules, \(2312\) source lines, \(126\) named declarations; no
