...
release has 53 modules and 9,746 kernel-source lines; the thirteen later modules
...
6. The public-instance audit inspected 470 theorems and 285 instance binders.
   ...
   CI.
7. Every one of the 53 modules is classified in the tracked upstream-candidate
   inventory; 35 declarations are flagged for possible generalization,
