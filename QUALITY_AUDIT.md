...
release has 50 modules and 8,411 kernel-source lines; the ten later modules
...
6. The public-instance audit inspected 408 theorems and 252 instance binders.
   ...
   CI.
7. Every one of the 50 modules is classified in the tracked upstream-candidate
