...
struct LocalStats {
    ...
    u64 minimum_half_order_gcd_prime = 0;
    u64 minimum_half_order_gcd_order5 = 0;
    u64 minimum_half_order_gcd_orderD = 0;
...
int main(int argc, char** argv) {
    ...
    for (u64 segment_low = low_global;
        ...
        for (std::size_t index = 0; index < split_primes.size(); ++index) {
            ...
            if (half_order_gcd < stats.minimum_half_order_gcd) {
                stats.minimum_half_order_gcd = half_order_gcd;
                stats.minimum_half_order_gcd_prime = p;
                stats.minimum_half_order_gcd_order5 = order5;
                stats.minimum_half_order_gcd_orderD = orderD;
            }
    ...
    for (LocalStats& stats : locals) {
        ...
        if (stats.minimum_half_order_gcd < total.minimum_half_order_gcd) {
            total.minimum_half_order_gcd = stats.minimum_half_order_gcd;
            total.minimum_half_order_gcd_prime =
                stats.minimum_half_order_gcd_prime;
            total.minimum_half_order_gcd_order5 =
                stats.minimum_half_order_gcd_order5;
            total.minimum_half_order_gcd_orderD =
                stats.minimum_half_order_gcd_orderD;
        }
    ...
    output << "  \"schema\": 2,\n";
    output << "  \"program\": ";
    append_json_string(output, "scan_profili_H_intervallo_v2.cpp");
    output << ",\n";
    ...
    output << ",\n";
    output << "  \"minimum_half_order_gcd_witness\": ";
    if (total.minimum_half_order_gcd == std::numeric_limits<u64>::max()) {
        output << "null";
    } else {
        output << "{\"p\":" << total.minimum_half_order_gcd_prime
               << ",\"ord_5\":" << total.minimum_half_order_gcd_order5
               << ",\"ord_epsilon2\":"
               << total.minimum_half_order_gcd_orderD << "}";
    }
    output << ",\n";
