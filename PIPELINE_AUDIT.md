...
| Per-theorem axiom measurement | `AxiomAudit.lean` on 72 headline declarations | complete |
...
[`upstream_candidates.json`](upstream_candidates.json) classifies all 45
...
every public theorem. The audit inspected 373 public theorems and 224 instance
