...
| Per-theorem axiom measurement | `AxiomAudit.lean` on 141 headline declarations | complete |
...
[`upstream_candidates.json`](upstream_candidates.json) classifies all 56
...
every public theorem. The audit inspected 515 public theorems and 340 instance
